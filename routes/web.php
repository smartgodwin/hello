...
use App\Http\Controllers\CarnetAdresseController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/notes/{note:uuid}', [NoteController::class, 'show'])->name('notes.show');
    Route::get('/notes/{note:uuid}/edit', [NoteController::class, 'edit'])->name('notes.edit');
    ...
    Route::get('/carnet_adresses', [CarnetAdresseController::class, 'index'])->name('carnet_adresses.index');
    Route::get('/carnet_adresses/create', [CarnetAdresseController::class, 'create'])->name('carnet_adresses.create');
    Route::post('/carnet_adresses', [CarnetAdresseController::class, 'store'])->name('carnet_adresses.store');
    Route::get('/carnet_adresses/{carnet_adresse:uuid}', [CarnetAdresseController::class, 'show'])->name('carnet_adresses.show');
    Route::get('/carnet_adresses/{carnet_adresse:uuid}/edit', [CarnetAdresseController::class, 'edit'])->name('carnet_adresses.edit');
    Route::put('/carnet_adresses/{carnet_adresse:uuid}', [CarnetAdresseController::class, 'update'])->name('carnet_adresses.update');
    Route::delete('/carnet_adresses/{carnet_adresse:uuid}', [CarnetAdresseController::class, 'destroy'])->name('carnet_adresses.destroy');
