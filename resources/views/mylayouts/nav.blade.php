        ...
        <div class="container mt-4" style="overflow-y: scroll; margin-bottom: 20px; padding-bottom:20px;">
            <div class="side_contener">
                <div class="side_option">
                    <a class="text-decoration-none" href="/"><h5><span class="me-3"><i class="fa-solid fa-house"></i></span>{{__('Accueil')}}</h5></a>
                </div>
                <div class="side_option">
                    <a class="text-decoration-none" href="/search"><h5><span class="me-3"><i class="fa-solid fa-magnifying-glass-location"></i></span>{{__('Rechercher')}}</h5></a>
                </div>
                <div class="side_option disable">
                    <a class="text-decoration-none" href="{{route('notes.index')}}"><h5><span class="me-3"><i class="fa-solid fa-book"></i></span>{{__('Notes')}}</h5></a>
                </div>
                <div class="side_option disable">

                    <a class="text-decoration-none" href="{{route('carnet_adresses.index')}}">
                        <h5><span class="me-3"><i class="far fa-address-book"></i></span>{{__('Carnet d\'adresses')}}</h5>
                    </a>
                </div>
                <div class="side_option disable">

                    <a class="text-decoration-none" href="{{route('favories.index')}}">
                        <h5><span class="me-3"><i class="fa-solid fa-bookmark"></i></span>{{__('Favories')}}</h5>
                    </a>
                </div>
                <div class="side_option">
                    @auth

                    <a class="text-decoration-none" href="{{route('user.addresses',Auth::user()->id)}}"><h5><span class="me-3"><i class="fa-solid fa-map-location-dot"></i></span> {{ __('Mes adresses') }}</h5></a>
