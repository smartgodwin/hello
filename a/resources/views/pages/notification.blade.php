...
@section('main')
    @if (session('sucess'))
        <div class="toast align-items-center position-absolute text-bg-info float-end" role="alert" aria-live="assertive"
            aria-atomic="true">
            <div class="d-flex">
                                ...
                                <form class="w-30" action="{{ route('notifications.markasread', $notification->id) }}"
                                    ...
                                    <button type="submit" class="btn btn-link link-underline-opacity-0 link-secondary"
                                        ...
                                        @if ($notification->read_at)
                                            <span><i class="fa-solid fa-check-double link-primary me-2"></i>lu</span>
                                        @else
                                            <span><i class="fa-solid fa-check-double link-secondary me-2"></i>lire</span>
                                        @endif
                                    </button>
                                </form>
